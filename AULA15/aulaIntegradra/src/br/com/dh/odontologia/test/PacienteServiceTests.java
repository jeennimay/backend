...
public class PacienteServiceTests {
    ...
    public static void carregarDataSet(){
        Endereco end1 = new Endereco("Av. Brasil", "325", "Centro", "Pelotas");
        Paciente p1 = pacienteService.salvar(new Paciente("Carla", "Santos", "2165784523", new Date(), end1));
    ...
    public void cadastrarEBuscarPacienteTest(){
        Endereco end4 = new Endereco("Av. Bento Martins", "866", "Centro", "Porto Alegre");
        Paciente p4 = pacienteService.salvar(new Paciente("Richard", "Silveira", "5411778541", new Date(), end4));
